...
- **Explicit approval of this result** — "approve", "lgtm", "looks good", or an equally clear statement in context — proceed to Step 11.
- **Feedback** — read the annotations in Step 9 and the user's message, apply in-scope fixes, rerun affected checks, then present the updated result.
